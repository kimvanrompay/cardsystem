...
class StaticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create static" do
    assert_difference("Static.count") do
      post statics_url, params: { static: { disclaimer: @static.disclaimer, home: @static.home } }
    end
  ...
  test "should update static" do
    patch static_url(@static), params: { static: { disclaimer: @static.disclaimer, home: @static.home } }
